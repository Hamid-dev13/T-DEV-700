...
function EditTeamModal({ isOpen, onClose, onTeamUpdated, team }: EditTeamModalProps) {
  ...
  useEffect(() => {
    if (isOpen && team) {
      setFormData({
        ...
        start_hour: team.startHour || 9,
        end_hour: team.endHour || 17,
      });
      setError('');
    }
  }, [isOpen, team]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 relative">
        ...
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Modifier l'équipe</h2>
        </div>
